...
- **Importance × Prevalence:** importance = how much one customer cares (1-4 scale, inferred only when stated). Prevalence = how many customers express the opportunity. Combined, they're the sizer's ranking signal.
